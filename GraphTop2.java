...
public class GraphTop2 {
        ...
        { 
            ...
            { 
                ...
                if (isHospital(s)) {
                    ...
                    if (pathCnt==2) //if we already found a hospital, break
                        break;
                }
    ...
    private void BFSforEachNode() {
        try {
                ...
                System.out.println("Default output file name is <RoadMap_Top2.txt>");
                System.out.println();
                ...
                if(writeTo.isEmpty()) {
                    System.out.println("Default output file name is RoadMap_Top2.txt");
                    writeTo = "RoadMap_Top2.txt"; // default output file name
    ...
    { 
        ...
        GraphTop2 g = new GraphTop2(max, hospitals);
