...
public class GraphTopK {
    ...
    // get BFS traversal from a given source s and write to a file
        void BFS(int s, FileWriter myWriter, int k) throws IOException
        { 
            ...
            int pathCnt = 0;//a counter to record how many hospitals we found.
            ...
            { 
                ...
                if (isHospital(s)) {
                    canReach = true;
                    String path = "";
                    pathCnt++; //increment the counter once we found an hospital.
                    myWriter.write("Top " + pathCnt + " shortest path:"); 
                    path = printPath(s, parents, firstParent, path);// output the path to the file
                                                                            //once we found a hospital.
                    ...
                    if (pathCnt==k) //if we already found a hospital, break
                        break;
                }                
    ...
    private void BFSforEachNode(int k) {
        try {
                ...
                System.out.println("Default output file name is <RoadMap_TopK.txt>");
                System.out.println();
                ...
                if(writeTo.isEmpty()) {
                    System.out.println("Default output file name is RoadMap_TopK.txt");
                    writeTo = "RoadMap_TopK.txt"; // default output file name
...
Scanner reader = new Scanner(System.in);
        ...
        int k = 2;
        do{
            System.out.println("Enter the number of nearest hospitals you want to search: ");
        ...
        GraphTopK g = new GraphTopK(max, hospitals);
        ...
        g.BFSforEachNode(k); //call function
    } 
}